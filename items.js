...
window.ALBION_ITEMS = [
  ...
  { id: "T6_MOUNT_DIREWOLF",          name: "Master's Direwolf" },
  { id: "T8_MOUNT_DIREWOLF",          name: "Elder's Direwolf" },
  { id: "T8_MOUNT_MAMMOTH_TRANSPORT", name: "Elder's Transport Mammoth" },
  { id: "T5_MOUNT_GIANTSTAG",         name: "Expert's Moose" },
  { id: "T7_MOUNT_GIANTSTAG",         name: "Grandmaster's Moose" },
  { id: "T8_MOUNT_GIANTSTAG",         name: "Elder's Moose" },
  { id: "T5_MOUNT_STAG",              name: "Expert's Stag" },
  { id: "T7_MOUNT_STAG",              name: "Grandmaster's Stag" },
  { id: "T8_MOUNT_STAG",              name: "Elder's Stag" },
  { id: "T5_MOUNT_DIREBEAR",          name: "Expert's Direbear" },
  { id: "T7_MOUNT_DIREBEAR",          name: "Grandmaster's Direbear" },
  { id: "T8_MOUNT_DIREBEAR",          name: "Elder's Direbear" },
  { id: "T5_MOUNT_DIREBOAR",          name: "Expert's Direboar" },
  { id: "T7_MOUNT_DIREBOAR",          name: "Grandmaster's Direboar" },
  { id: "T8_MOUNT_DIREBOAR",          name: "Elder's Direboar" },
  { id: "T4_MOUNT_SWAMPDRAGON",       name: "Adept's Swamp Salamander" },
  { id: "T6_MOUNT_SWAMPDRAGON",       name: "Master's Swamp Salamander" },
  { id: "T8_MOUNT_SWAMPDRAGON",       name: "Elder's Swamp Salamander" },
  { id: "T4_MOUNT_TERRORBIRD",        name: "Adept's Terror Bird" },
  { id: "T6_MOUNT_TERRORBIRD",        name: "Master's Terror Bird" },
  { id: "T8_MOUNT_TERRORBIRD",        name: "Elder's Terror Bird" },
  { id: "T5_MOUNT_COUGAR",            name: "Expert's Cougar Cub" },
  { id: "T7_MOUNT_COUGAR",            name: "Grandmaster's Cougar" },
  { id: "T8_MOUNT_COUGAR",            name: "Elder's Cougar" },
  { id: "T4_MOUNT_ARMORED_HORSE",     name: "Adept's Armored Horse" },
  { id: "T6_MOUNT_ARMORED_HORSE",     name: "Master's Armored Horse" },
  { id: "T8_MOUNT_ARMORED_HORSE",     name: "Elder's Armored Horse" },
  { id: "T5_MOUNT_HUSKY",             name: "Expert's Husky" },
  { id: "T7_MOUNT_HUSKY",             name: "Grandmaster's Husky" },
  { id: "T8_MOUNT_HUSKY",             name: "Elder's Husky" },
  { id: "T5_MOUNT_RHINOCEROS",        name: "Expert's Rhino" },
  { id: "T7_MOUNT_RHINOCEROS",        name: "Grandmaster's Rhino" },
  { id: "T8_MOUNT_RHINOCEROS",        name: "Elder's Rhino" },
  { id: "T8_MOUNT_RHINOCEROS_WHITE",  name: "Elder's White Rhino" },
  { id: "T8_MOUNT_ARMORED_RHINOCEROS",name: "Elder's Armored Rhino" },
  { id: "T5_MOUNT_GIANT_HORSE",       name: "Expert's Giant Horse" },
  { id: "T8_MOUNT_GIANT_HORSE",       name: "Elder's Giant Horse" },
  { id: "T8_MOUNT_UNDEAD_HORSE",      name: "Elder's Spectral Horse" },
  { id: "T8_MOUNT_MAMMOTH",           name: "Elder's Mammoth" },
  { id: "T7_MOUNT_MAMMOTH",           name: "Grandmaster's Mammoth" },
  { id: "T5_MOUNT_MULE",              name: "Expert's Mule" },
  { id: "T7_MOUNT_MULE",              name: "Grandmaster's Mule" },
  { id: "T8_MOUNT_MULE",              name: "Elder's Mule" },

  // ── FACTION MOUNTS — Regular ────────────────────────────────────
  { id: "MOUNT_FACTIONANIMAL_BRIDGEWATCH",  name: "Bridgewatch Boar" },
  { id: "MOUNT_FACTIONANIMAL_LYMHURST",     name: "Lymhurst Fox" },
  { id: "MOUNT_FACTIONANIMAL_FORTSTERLING", name: "Fort Sterling Ram" },
  { id: "MOUNT_FACTIONANIMAL_MARTLOCK",     name: "Martlock Bear" },
  { id: "MOUNT_FACTIONANIMAL_THETFORD",     name: "Thetford Fawn" },
  { id: "MOUNT_FACTIONANIMAL_CAERLEON",     name: "Caerleon Moose" },

  // ── FACTION MOUNTS — Elite ──────────────────────────────────────
  { id: "MOUNT_FACTIONANIMAL_BRIDGEWATCH_ELITE",  name: "Elite Bridgewatch Boar" },
  { id: "MOUNT_FACTIONANIMAL_LYMHURST_ELITE",     name: "Elite Lymhurst Fox" },
  { id: "MOUNT_FACTIONANIMAL_FORTSTERLING_ELITE", name: "Elite Fort Sterling Ram" },
  { id: "MOUNT_FACTIONANIMAL_MARTLOCK_ELITE",     name: "Elite Martlock Bear" },
  { id: "MOUNT_FACTIONANIMAL_THETFORD_ELITE",     name: "Elite Thetford Fawn" },
  { id: "MOUNT_FACTIONANIMAL_CAERLEON_ELITE",     name: "Elite Caerleon Moose" },

  // ── FACTION MOUNTS — Baby (elite baby mounts) ───────────────────
  { id: "MOUNT_FACTIONBABY_BRIDGEWATCH",  name: "Baby Bridgewatch Boar" },
  { id: "MOUNT_FACTIONBABY_LYMHURST",    name: "Baby Lymhurst Fox" },
  { id: "MOUNT_FACTIONBABY_FORTSTERLING",name: "Baby Fort Sterling Ram" },
  { id: "MOUNT_FACTIONBABY_MARTLOCK",    name: "Baby Martlock Bear" },
  { id: "MOUNT_FACTIONBABY_THETFORD",   name: "Baby Thetford Fawn" },
  { id: "MOUNT_FACTIONBABY_CAERLEON",   name: "Baby Caerleon Moose" },

  // ── PREMIUM / SPECIAL MOUNTS ────────────────────────────────────
  { id: "MOUNT_HORSE_UNDEAD",           name: "Spectral Horse" },
  { id: "MOUNT_GIANT_HORSE",            name: "Giant Horse" },
  { id: "MOUNT_ARMORED_RHINOCEROS",     name: "Armored Rhino" },
  { id: "MOUNT_RHINOCEROS_BIGHORN",     name: "Bighorn Rhino" },
  { id: "MOUNT_GREATSNOWBEAR",          name: "Greatsnow Bear" },
  { id: "MOUNT_PANTHER",                name: "Panther" },
  { id: "MOUNT_GREYWOLF",               name: "Greywolf" },
  { id: "MOUNT_BONEHORSE",              name: "Bone Horse" },
  { id: "MOUNT_FROG",                   name: "Sabertooth Frog" },
  { id: "MOUNT_RABBIT",                 name: "Rabbit" },
  { id: "MOUNT_SHEEP",                  name: "Sheep" },
  { id: "MOUNT_CROW",                   name: "Giant Crow" },
